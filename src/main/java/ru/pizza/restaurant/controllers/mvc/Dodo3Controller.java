...
@Controller
@RequestMapping("/dodo3")
public final class Dodo3Controller extends DodoParent {

     {
        RESTAURANT_NAME = Restaurant.DODO3;
    }


    public Dodo3Controller(RestBuildingService buildingService, RestNewDeliveryService newDeliveryService, RestOrderBasketService orderBasketService) {
